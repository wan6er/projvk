...
VkResult MemorizedImageView<_ImageViewBase>::create_view(VkPhysicalDeviceMemoryProperties CONST_REFERENCE properties, VkMemoryPropertyFlags property, VkImageAspectFlags aspect, __Args&&...args)
{
