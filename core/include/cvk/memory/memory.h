...
namespace cvk
{
    ...
    public:
        ...
        VkResult allocate(VkPhysicalDeviceMemoryProperties CONST_REFERENCE properties, VkMemoryRequirements CONST_REFERENCE requirements, VkMemoryPropertyFlags property);
        VkResult allocate(uint32_t size, uint32_t type_index);
