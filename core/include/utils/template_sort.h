...
namespace utils
{
    ...
    {
        using _NextMat = _Max<_ValType, _Next + 1, 
        ...
        static constexpr size_t index = _NextMat::index;
        static constexpr _ValType max = _NextMat::max;
    };
    ...
    template<typename, size_t _Start, size_t _Next, typename _ValType, _ValType..._Elements>
    struct _RangeMaxImpl;

    template<size_t _Start, size_t _Next, typename _ValType, _ValType _Head, _ValType..._Tail>
    struct _RangeMaxImpl<std::enable_if_t<!EqualVal<size_t, _Next, 0>, int>, _Start, _Next, _ValType, _Head, _Tail...> :
        public _RangeMaxImpl<int, _Start, _Next - 1, _ValType, _Tail...>
    {};
    
    template<size_t _Start, typename _ValType, _ValType..._Elemenst>
    struct _RangeMaxImpl<int, _Start, 0, _ValType, _Elemenst...>
    {
    ...
    template<size_t _Start, typename _ValType, _ValType..._Elemenst>
    using RangeMax = _RangeMaxImpl<int, _Start, _Start, _ValType, _Elemenst...>;
