...
namespace cvk
{
    ...
    auto AccStructGeometry::instances() -> AccStructGeometryDataInstances&
    {
    ...
    auto AccStructGeometry::instances() const -> AccStructGeometryDataInstances CONST_REFERENCE
    {
        return static_cast<AccStructGeometryDataInstances CONST_REFERENCE>(geometry.instances);
    }

    auto AccStructGeometry::triangles() -> AccStructGeometryDataTriangles&
    {
    ...
    auto AccStructGeometry::triangles() const -> AccStructGeometryDataTriangles CONST_REFERENCE
    {
