...
void get_default_image_view_create_info(VkImageViewCreateInfo& create_info)
{
    create_info = {};
...
void get_image_view_create_info(VkFormat format, VkImageViewType type, VkImageAspectFlags aspect, VkImage image, VkImageViewCreateInfo& create_info)
{
...
void get_image_view_create_info(VkFormat format, VkImageViewType type, VkImage image, VkImageSubresourceRange CONST_REFERENCE subresource, VkImageViewCreateInfo& create_info)
{
    create_info.image = image;
    create_info.viewType = type;
    create_info.format = format;
    create_info.subresourceRange = subresource;
}
