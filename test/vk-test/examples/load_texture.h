...
void load_texture(cvk::Device CONST_REFERENCE device, std::string filename, uint32_t graphics_index, cvk::Texture2D& texture)
{
    ...
    CVK_ASSERT(texture_stage.upload(target->pData, texture_stage.get_memory_size()) == VK_SUCCESS);
