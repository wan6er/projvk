...
#error unsupport platform
    ...
    cvk::DescriptorSet tex_set[2] = {{ device, descriptor_pool, tex_layout }, { device, descriptor_pool, tex_layout1 } };
    CHECK(tex_set[0].allocate() == VK_SUCCESS);
    CHECK(tex_set[1].allocate() == VK_SUCCESS);
